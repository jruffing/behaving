...
class TrustStore:
    ...
    def _add_record(self, sha1, subj, tset, data):
        """
        # printing for debug"
        print "sqlite3.Binary(sha1): " + str(binascii.hexlify(sqlite3.Binary(sha1))).upper()
        print "sqlite3.Binary(subj): " + str(binascii.hexlify(sqlite3.Binary(subj))).upper()
        print "sqlite3.Binary(tset): " + str(binascii.hexlify(sqlite3.Binary(tset))).upper()
        print "sqlite3.Binary(data): " + str(binascii.hexlify(sqlite3.Binary(data))).upper()
        """
